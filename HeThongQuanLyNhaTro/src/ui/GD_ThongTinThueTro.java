...
public class GD_ThongTinThueTro extends JPanel implements ActionListener, MouseListener {
	...
	private JButton btnTimNhaTro;
	private JButton btnTimSinhVien;
	private JButton btnThemmTroMoi;
	...
	public GD_ThongTinThueTro() {
		...
		pnlMenuCon.setLayout(new GridLayout(7, 1));
		...
		pnlTimKiem.setLayout(new GridLayout(1, 4));

		JPanel pnlTimKiemSinhVien = new JPanel();
		pnlTimKiemSinhVien.setBorder(new EmptyBorder(5, 5, 5, 5));
		pnlTimKiem.add(pnlTimKiemSinhVien);
		pnlTimKiemSinhVien.setLayout(new BorderLayout(0, 0));

		 btnTimSinhVien = new JButton("Tìm kiếm Sinh viên");
		btnTimSinhVien.setBackground(new Color(0, 191, 255));
		btnTimSinhVien.setFont(new Font("Arial", Font.BOLD, 20));
		pnlTimKiemSinhVien.add(btnTimSinhVien);

		JPanel pnlTiemKiemNhaTro = new JPanel();
		pnlTiemKiemNhaTro.setBorder(new EmptyBorder(5, 5, 5, 5));
		pnlTimKiem.add(pnlTiemKiemNhaTro);
		pnlTiemKiemNhaTro.setLayout(new BorderLayout(0, 0));

		 btnTimNhaTro = new JButton("Tìm kiếm nhà trọ");
		btnTimNhaTro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnTimNhaTro.setBackground(new Color(240, 128, 128));
		btnTimNhaTro.setFont(new Font("Arial", Font.BOLD, 20));
		pnlTiemKiemNhaTro.add(btnTimNhaTro);

		JPanel pnlThemTroMoi = new JPanel();
		pnlThemTroMoi.setBorder(new EmptyBorder(5, 5, 5, 5));
		pnlTimKiem.add(pnlThemTroMoi);
		pnlThemTroMoi.setLayout(new BorderLayout(0, 0));

		btnThemmTroMoi = new JButton("Thêm trọ mới");
		btnThemmTroMoi.setBackground(new Color(255, 215, 0));
		btnThemmTroMoi.setFont(new Font("Arial", Font.BOLD, 20));
		pnlThemTroMoi.add(btnThemmTroMoi);

		JPanel pnlHienThiLichSuThayDoi = new JPanel();
		pnlHienThiLichSuThayDoi.setBorder(new EmptyBorder(5, 5, 5, 5));
		pnlTimKiem.add(pnlHienThiLichSuThayDoi);
		pnlHienThiLichSuThayDoi.setLayout(new BorderLayout(0, 0));

		btnXemLichSu = new JButton("Xem lịch sử thay đổi trọ");
		btnXemLichSu.setBackground(new Color(50, 205, 50));
		btnXemLichSu.setFont(new Font("Arial", Font.BOLD, 20));
		pnlHienThiLichSuThayDoi.add(btnXemLichSu);
		...
		btnTimNhaTro.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				btnTimNhaTro.setBackground(new Color(255, 26, 26));
			}
		...
		btnTimSinhVien.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				btnTimSinhVien.setBackground(new Color(30, 144, 255));
			}
		...
		btnThemmTroMoi.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				btnThemmTroMoi.setBackground(new Color(230, 184, 0));
			}
		...
		btnXemLichSu.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				btnXemLichSu.setBackground(new Color(0, 153, 0));
			}
		...
		btnTimSinhVien.addActionListener(this);
		btnTimNhaTro.addActionListener(this);
		btnThemmTroMoi.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if (o.equals(btnThemmTroMoi)) {
			JOptionPane.showMessageDialog(this, new GD_ThemTroMoi());
		}else if (o.equals(btnTimSinhVien)) {
			JFrame timkiem = new DiaLog_TimKiemSinhVien();
